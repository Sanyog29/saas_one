...
const SuperTenantDashboard = () => {
    ...
    const fetchTickets = useCallback(async () => {
        ...
        if (data) {
            setActiveTickets(data.filter((t: any) => !['resolved', 'closed'].includes(t.status)));
            setCompletedTickets(data.filter((t: any) => ['resolved', 'closed'].includes(t.status)));
        }
            ...
            <div className="md:hidden flex items-center justify-center bg-slate-600/80 backdrop-blur-sm rounded-full p-1 shadow-inner">
                {(['today', 'thismonth', 'all'] as const).map((p) => (
                    <button
                        ...
                        className={`flex-1 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full transition-all ${timePeriod === p
                            ...
                            {activeTab === 'overview' && (
                                <div className="hidden md:flex items-center bg-slate-600/80 backdrop-blur-sm rounded-full p-1 shadow-inner">
                                    <button
                                        ...
                                        className={`px-4 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full transition-all ${timePeriod === 'today'
                                            ? 'bg-yellow-400 text-slate-900 shadow-md'
                                            : 'text-white/80 hover:text-white'}`}
                                    >
                                        Today
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full transition-all ${timePeriod === 'thismonth'
                                            ? 'bg-yellow-400 text-slate-900 shadow-md'
                                            : 'text-white/80 hover:text-white'}`}
                                    >
                                        This Month
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full transition-all ${timePeriod === 'all'
                                            ? 'bg-yellow-400 text-slate-900 shadow-md'
                                            : 'text-white/80 hover:text-white'}`}
                                    >
                                        All Time
